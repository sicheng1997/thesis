...
basedir=$HOME/biosoft/GISTIC/output/coad_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-COAD/data_output/TCGA-COAD_overweight_seg.txt
