...
basedir=$HOME/biosoft/GISTIC/output/dlbc_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-DLBC/data_output/TCGA-DLBC_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/dlbc_underweight.log 2>&1
