...
basedir=$HOME/biosoft/GISTIC/output/cesc_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-CESC/data_output/TCGA-CESC_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/cesc_underweight.log 2>&1
