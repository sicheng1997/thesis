...
basedir=$HOME/biosoft/GISTIC/output/uvm_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-UVM/data_output/TCGA-UVM_underweight_seg.txt
