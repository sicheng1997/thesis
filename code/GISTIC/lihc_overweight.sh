...
basedir=$HOME/biosoft/GISTIC/output/lihc_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-LIHC/data_output/TCGA-LIHC_overweight_seg.txt
