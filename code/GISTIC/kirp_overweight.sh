...
basedir=$HOME/biosoft/GISTIC/output/kirp_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-KIRP/data_output/TCGA-KIRP_overweight_seg.txt
