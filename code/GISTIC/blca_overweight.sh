...
basedir=$HOME/biosoft/GISTIC/output/blca_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-BLCA/data_output/TCGA-BLCA_overweight_seg.txt
