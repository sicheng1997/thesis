...
basedir=$HOME/biosoft/GISTIC/output/blca_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-BLCA/data_output/TCGA-BLCA_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/blca_underweight.log 2>&1
