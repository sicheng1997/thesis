...
basedir=$HOME/biosoft/GISTIC/output/ucs_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-UCS/data_output/TCGA-UCS_overweight_seg.txt
