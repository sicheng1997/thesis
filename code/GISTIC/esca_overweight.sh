...
basedir=$HOME/biosoft/GISTIC/output/esca_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-ESCA/data_output/TCGA-ESCA_overweight_seg.txt
