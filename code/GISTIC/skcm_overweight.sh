...
basedir=$HOME/biosoft/GISTIC/output/skcm_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-SKCM/data_output/TCGA-SKCM_overweight_seg.txt
