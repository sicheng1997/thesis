...
basedir=$HOME/biosoft/GISTIC/output/skcm_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-SKCM/data_output/TCGA-SKCM_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/skcm_underweight.log 2>&1
