...
basedir=$HOME/biosoft/GISTIC/output/thym_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-THYM/data_output/TCGA-THYM_overweight_seg.txt
