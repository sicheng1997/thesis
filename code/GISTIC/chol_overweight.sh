...
basedir=$HOME/biosoft/GISTIC/output/chol_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-CHOL/data_output/TCGA-CHOL_overweight_seg.txt
