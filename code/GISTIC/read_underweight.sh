...
basedir=$HOME/biosoft/GISTIC/output/read_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-READ/data_output/TCGA-READ_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/read_underweight.log 2>&1
