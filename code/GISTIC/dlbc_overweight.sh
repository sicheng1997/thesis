...
basedir=$HOME/biosoft/GISTIC/output/dlbc_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-DLBC/data_output/TCGA-DLBC_overweight_seg.txt
