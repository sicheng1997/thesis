...
basedir=$HOME/biosoft/GISTIC/output/coad_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-COAD/data_output/TCGA-COAD_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/coad_underweight.log 2>&1
