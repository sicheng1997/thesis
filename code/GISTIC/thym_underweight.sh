...
basedir=$HOME/biosoft/GISTIC/output/thym_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-THYM/data_output/TCGA-THYM_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/thym_underweight.log 2>&1
