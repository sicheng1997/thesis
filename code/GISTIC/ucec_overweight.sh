...
basedir=$HOME/biosoft/GISTIC/output/ucec_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-UCEC/data_output/TCGA-UCEC_overweight_seg.txt
