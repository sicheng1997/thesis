...
basedir=$HOME/biosoft/GISTIC/output/ucec_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-UCEC/data_output/TCGA-UCEC_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/ucec_underweight.log 2>&1
