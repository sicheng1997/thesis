...
basedir=$HOME/biosoft/GISTIC/output/kirp_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-KIRP/data_output/TCGA-KIRP_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/kirp_underweight.log 2>&1
