...
basedir=$HOME/biosoft/GISTIC/output/cesc_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-CESC/data_output/TCGA-CESC_overweight_seg.txt
