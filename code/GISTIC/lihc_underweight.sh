...
basedir=$HOME/biosoft/GISTIC/output/lihc_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-LIHC/data_output/TCGA-LIHC_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/lihc_underweight.log 2>&1
