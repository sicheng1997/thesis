...
basedir=$HOME/biosoft/GISTIC/output/uvm_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-UVM/data_output/TCGA-UVM_overweight_seg.txt
