...
basedir=$HOME/biosoft/GISTIC/output/read_overweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-READ/data_output/TCGA-READ_overweight_seg.txt
