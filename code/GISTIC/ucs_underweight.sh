...
basedir=$HOME/biosoft/GISTIC/output/ucs_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-UCS/data_output/TCGA-UCS_underweight_seg.txt
