...
basedir=$HOME/biosoft/GISTIC/output/esca_underweight
mkdir -p $basedir
echo --- running GISTIC ---
segfile=$HOME/Rproject/TCGA/TCGA-ESCA/data_output/TCGA-ESCA_underweight_seg.txt
...
-armpeel 1              \
-savegene 1             \
1> log/esca_underweight.log 2>&1
